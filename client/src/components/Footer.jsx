		...
		<Container as='footer' maxW='7xl'>
			...
			<Stack pt='8' pb='12' justify='space-between' direction={{ base: 'column-reverse', md: 'row' }} align='center'>
				<Text fontSize='sm' color='subtle'>
					&copy; {new Date().getFullYear()} Tech Nest, Inc. All rights reserved.
				</Text>
				<ButtonGroup variant='ghost'>
					<IconButton as='a' href='https://www.linkedin.com/in/alejandra-valdivia-developer/' icon={<FaLinkedin fontSize='1.25rem' />} />
					<IconButton as='a' href='https://github.com/AlejandraValdivia' icon={<FaGithub fontSize='1.25rem' />} />
				</ButtonGroup>
			</Stack>
		</Container>
	</Box>
